...
import { getUserRequest, getUsersRequest, createUserRequest, updateUserRequest, deleteUserRequest } from "../api/user";
...
export const UserProvider = ({ children }) => {
    ...
    return (
        <UserContext.Provider value={{ users, createUser, updateUser, deleteUser, getUsers, getUser }}>
            {children}
